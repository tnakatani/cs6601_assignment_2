...
class Board:
        ...
        for r, c in valid_moves:
            ...
            if distance <= 2:
                ...
                if distance >= 5:
                    ...
                    mistake_prob = (0.11, 0.22)[distance - 3]
    ...
    def play_isolation(self, time_limit=5000):
        ...
        if platform.system() == 'Windows':
            def curr_time_millis(): return int(round(time() * 1000))
        else:
            def curr_time_millis(): return 1000 * resource.getrusage(resource.RUSAGE_SELF).ru_utime
...
if __name__ == '__main__':
    ...
    winner, move_history, queen_history, termination = board.play_isolation(time_limit=500013)
