...
def notebook2scriptSingle(fname, destination):
    ...
    ##########
#     with open("workspace/mixture_models.py") as f:
#       s = f.read()
#       s = re.sub(r'(?m)^tests.*\n?', '', s) # removing the local tests code executions

#     # writing to the .py file
#     with open("workspace/mixture_models.py", "w") as f:
#       f.write(s)  
    #######
